...
export type inferInfiniteQueryNames<TObj extends ProcedureRecord<any, any, any, any>> =
  {
...
export type inferProcedures<TObj extends ProcedureRecord<any, any, any, any>> = {
  [TPath in keyof TObj]: {
